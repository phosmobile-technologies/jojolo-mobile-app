...
export type LoginMutation = { __typename?: "Mutation" } & {
  Login: { __typename?: "LoginResponse" } & Pick<LoginResponse, "access_token">;
};
...
export type SignUpCareGiverMutation = { __typename?: "Mutation" } & {
  SignUpCareGiver: { __typename?: "User" } & Pick<
    User,
    | "id"
    | "uuid"
    | "email"
  ...
  > & {
      care_giver_profile?: Maybe<
        { __typename?: "CareGiverProfile" } & Pick<
          CareGiverProfile,
          "id" | "uuid" | "country" | "state" | "city" | "address" | "role"
        > & {
            children: Array<
              Maybe<
                { __typename?: "Child" } & Pick<
                  Child,
                  | "first_name"
                  | "birth_term"
                  | "date_of_birth"
...
export type SignUpHealthCareProfessionalMutation = {
  ...
  SignUpHealthCareProfessional: { __typename?: "User" } & Pick<
    User,
    | "id"
    | "uuid"
    | "email"
  ...
  > & {
      health_care_professional_profile?: Maybe<
        { __typename?: "HealthCareProfessionalProfile" } & Pick<
          HealthCareProfessionalProfile,
          "id" | "years_of_experience"
        > & {
            verification_files: Array<
              { __typename?: "HealthCareProfessionalVerificationFile" } & Pick<
                HealthCareProfessionalVerificationFile,
                "id" | "file_url" | "type"
              >
            >;
          }
...
>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    SignUpCareGiverMutation,
    TError,
    SignUpCareGiverMutationVariables,
    TContext
  >
) =>
  useMutation<
    ...
    TContext
  >(
    (variables?: SignUpCareGiverMutationVariables) =>
      fetcher<SignUpCareGiverMutation, SignUpCareGiverMutationVariables>(
        client,
        SignUpCareGiverDocument,
        variables
      )(),
    options
  );
...
>(
  client: GraphQLClient,
  options?: UseMutationOptions<
    SignUpHealthCareProfessionalMutation,
    TError,
    SignUpHealthCareProfessionalMutationVariables,
    TContext
  >
) =>
  useMutation<
    ...
    TContext
  >(
    (variables?: SignUpHealthCareProfessionalMutationVariables) =>
      fetcher<
        SignUpHealthCareProfessionalMutation,
        SignUpHealthCareProfessionalMutationVariables
      >(client, SignUpHealthCareProfessionalDocument, variables)(),
    options
  );
